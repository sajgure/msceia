                                                ...
                                                <div class="row static-info">
                                                    ...
                                                    <div class="col-md-7 value">
                                                        ...
                                                        <?php } else if($order_data->order_status=='PACKED') { ?>
                                                            <span class="label label-sm" style="background-color: #7a518c;"><?php echo (isset($order_data->order_status) && !empty($order_data->order_status))?$order_data->order_status:''; ?>  </span>
                                                        <?php } else if($order_data->order_status=='DISPATHED') { ?>
                                            ...
                                            <?php if(isset($order_detail )&& !empty($order_detail )){ $total_amt = 0; ?>
                                                <div class="portlet-body" style="min-height: 480px; max-height: 480px;">
                                                    <div class="table-responsive">
                                                        ...
                                                        <!-- <?php if($order_data->order_status=='ORDERED' || $order_data->order_status=='ACCEPTED' || $order_data->order_status=='PACKED') { ?>
                                                            <a href="javascript:;" class="btn btn-danger deleteRecord" rel="<?php echo(isset($order_data->order_id) && !empty($order_data->order_id))?$order_data->order_id:''?>" rev="objective_cancel_order" style="color: white; margin-top: 10px;">Cancel Order</a>
                                                        <?php } ?> -->
                                                       <!--  <?php if($order_data->order_status=='DELIVERED') { ?>
                                                            <a href="<?php echo base_url(); ?>objective_book_print_invoice/<?php echo (isset($order_data->order_id) && !empty($order_data->order_id))?$order_data->order_id:''; ?>" class="btn purple pull-right">Download Invoice</a> 
                                                        <?php } ?> --> 
                                                    </div>

                                                    <?php if($order_data->order_status=='DELIVERED') { ?>
                                                        <a href="<?php echo base_url(); ?>objective_book_print_invoice/<?php echo (isset($order_data->order_id) && !empty($order_data->order_id))?$order_data->order_id:''; ?>" class="btn purple pull-right" style="margin-top: 32.5%;" >Download Invoice
                                                        </a> 
                                                    <?php } ?>
                                                </div>
                                            <?php }?>
                                                    ...
                                                    <?php } else { ?>
                                                        <div  style="min-height: 380px; max-height: 380px;">
                                                            <ul class="timeline">
                                                                ...
                                                                <?php } ?> 
                                                                <?php if($order_data->order_status=='CANCELED') { ?>
                                                                    <li>
                                                                        <div class="direction-r">
                                                                            <div class="flag-wrapper">
