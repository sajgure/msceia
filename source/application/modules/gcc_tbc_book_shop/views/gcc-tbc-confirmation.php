...
<head>
    <meta charset="utf-8">
    <title>Shop Confirmation | <?php echo (isset($appname) && !empty($appname))?$appname:'MSCEIA';?>
    </title>
        ...
        <div class="row margin-bottom-40">
          <div class="col-md-12 col-sm-12">
            ...
            <div class="goods-page">
                    ...
                    foreach($order_data as $items) { ?>
                      <tr>
                        <td class="goods-page-image">
                          <img src="<?php echo base_url();?>uploads/gcc_tbc_product_photos/<?php echo isset($items->product_image) && !empty($items->product_image)?$items->product_image:''; ?>">
                        </td>
                        <td class="goods-page-description" style="width: 60%;">
                            <h3>
                              <a style="text-decoration: none;font-weight:600;" href="javascript:;"><?php echo(isset($items->product_name) && !empty($items->product_name))?mb_substr($items->product_name, 0, 50):''?>
                              </a>
                            </h3>
                            <p style="font-weight: 500;">
                                <?php echo(isset($items->product_desc) && !empty($items->product_desc))?$items->product_desc:''?>
                            </p>
                        </td>
              ...
              <a href="<?php echo base_url();?>gcc-tbc-shop"><button class="btn blue" type="submit">Continue shopping <i class="fa fa-shopping-cart"></i></button></a>
