                    ...
                    <div class="col-md-9 col-sm-9">
                        <div class="portlet box blue">
                            <div class="portlet-title">
                                <div class="caption"> <i class="fa fa-gift"></i>माझे खाते </div>
                            </div>
                            <div class="portlet-body form">
                                <form action="institute" id="institute" class="horizontal-form" data-apikey="<?php echo(isset($keydata->key) && !empty($keydata->key))?$keydata->key:'';?>" data-redirect="my-profile" method="post" enctype="multipart/form-data">
                                 <div class="form-body row">
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                ...
                                                <div class="uploaded_image" style="padding-bottom: 10px !important;">
                                                    <img src="<?php echo base_url(); ?>uploads/inst_owner_photos/<?php echo(isset($user_data->institute_owner_photo) && !empty($user_data->institute_owner_photo))?$user_data->institute_owner_photo:'default.png';?>" onerror="this.src='<?php echo base_url(); ?>uploads/inst_owner_photos/default.png';" style="height: 130px; width: 200px;" class="img-thumbnail"/>
                                                </div>
                                                <input type="file" name="file" id="file" class="upload_image" data-url="upload_institute_onwer_image">
                                                <label for="file" class="upload_button" /><?php echo(isset($user_data->institute_owner_photo) && !empty($user_data->institute_owner_photo))?'Change':'Select File';?></label>
                                                <input type="hidden" name="institute_owner_photo" class="file_name" value="<?php echo(isset($user_data->institute_owner_photo) && !empty($user_data->institute_owner_photo))?$user_data->institute_owner_photo:'default.png';?>">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-4">
                                                    <div class="form-group">
                                                        ...
                                                        <div class="input-icon right">
                                                             <i class="fa"></i>
                                                            <input type="text" name="institute_code" class="form-control" placeholder="Institute Code" value="<?php echo (isset($user_data->institute_code) && !empty($user_data->institute_code))?$user_data->institute_code:'';?>" readonly>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="col-md-4">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div class="input-icon right"> <i class="fa"></i>
                                                            <div class="input-group date date-picker" data-date-format="dd-mm-yyyy" data-date-end-date="0d" data-date-viewmode="years">
                                                                    <input type="text" name="institute_owner_dob" class="form-control" readonly="" placeholder="Date Of Birth" value="<?php echo (isset($user_data->institute_owner_dob) && !empty($user_data->institute_owner_dob))?date('d-m-Y',strtotime($user_data->institute_owner_dob)):'';?>"> <span class="input-group-btn">
                                        ...
                                        <div class="col-md-8">
                                            <div class="form-group">
                                                ...
                                                <div class="input-icon right">
                                                    <i class="fa"></i>
                                                    <textarea name="institute_address" class="form-control" placeholder=" Institute Address" rows="2" required><?php echo (isset($user_data->institute_address) && !empty($user_data->institute_address))?$user_data->institute_address:'';?></textarea >
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-md-4">
                                        ...
                                        <input type="hidden" name="institute_status" value="<?php echo (isset($user_data->institute_status) && !empty($user_data->institute_status))?$user_data->institute_status:'';?>">
                                    </div>
                                    <div class="form-actions right">
                                        <a href="<?php echo base_url();?>my-profile" class="btn green">Back</a>
                                        <button type="submit" class="btn blue common_save" data-pk="institute_id">Update</button>
                                    </div>
                                </form>
                            </div>
                        </div>
