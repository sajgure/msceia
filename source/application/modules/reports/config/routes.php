...
$route['(?i)certificate-pdf/(:any)/(:any)/(:any)'] ='reports/report_web/certificate_pdf/$1/$2/$3';
$route['(?i)ssd-certificate-pdf/(:any)/(:any)/(:any)'] ='reports/report_web/ssd_certificate_pdf/$1/$2/$3';
$route['(?i)pass-student-list/(:any)/(:any)'] = 'reports/report_web/pass_student_list/$1/$2';
