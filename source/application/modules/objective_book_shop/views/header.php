                ...
                <div class="top-cart-content">
                    ...
                    {?>
                        <div class="text-right">
                            <a href="<?php echo base_url();?>objective-book-shop-view-cart" class="btn blue">View Cart</a>
                            <a href="<?php echo base_url();?>objective-book-shop-checkout" class="btn btn-primary">Checkout</a>
                        </div>
                    <?php } ?>
                </div>
            </div>             
