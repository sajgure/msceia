...
<head>
    <meta charset="utf-8">
    <title>GCC TBC Shop | <?php echo (isset($appname) && !empty($appname))?$appname:'MSCEIA';?>
    </title>
    ...
    <div class="page-slider margin-bottom-40">
        <div class="fullwidthbanner-container revolution-slider">
            <div class="fullwidthabnner">
                <ul id="revolutionul">
                    <!-- THE NEW SLIDE -->
                    <?php if(isset($book_slider_data) && !empty($book_slider_data))
                    { 
                      foreach ($book_slider_data as $key)
                        { ?>
                        <li data-transition="fade" data-slotamount="8" data-masterspeed="700" data-delay="9400" data-thumb="<?php echo base_url();?>uploads/gcc_tbc_slider_photos/<?php echo (isset($key->image_upload) && !empty($key->image_upload))?$key->image_upload:'';?>">
                            <!-- THE MAIN IMAGE IN THE FIRST SLIDE -->
                            <img src="<?php echo base_url();?>uploads/gcc_tbc_slider_photos/<?php echo (isset($key->image_upload) && !empty($key->image_upload))?$key->image_upload:'';?>"> </li>
                        <?php }
                    } ?>
                </ul>
            </div>
            ...
            <div class="row margin-bottom-40">
                <?php $this->load->view('gcc_tbc_book_shop/gcc-tbc-book-sidebar'); ?>
                    ...
                    <div class="col-md-9 col-sm-7">
                        <form action="objective_add_to_cart" enctype="multipart/form-data" id="objective_add_to_cart" method="post" class="horizontal-form" data-redirect="gcc-tbc-book-shop-view-cart">
                            <?php if(isset($book_product_data) && !empty($book_product_data))
                            {  ?>
                                <?php foreach ($book_product_data as $key) { ?>
                                    <div class="goods-page">
                                        <div class="goods-data clearfix">
                                            <div class="table-wrapper-responsive">
                                                <table summary="Shopping cart" width="100%">
                                                    <tr>
                                                        <td style="border-bottom: none;" class="goods-page-image"> <img src="<?php echo base_url(); ?>uploads/gcc_tbc_product_photos/<?php echo(isset($key->product_image) && !empty($key->product_image))?$key->product_image:''?>" alt="product Photo" class="img-responsive"> </td>
                                                        <td style="border-bottom: none;" class="goods-page-description">
                                                            <h3><a style="text-decoration: none;font-weight:600;" href="javascript:;"><?php echo(isset($key->product_name) && !empty($key->product_name))?mb_substr($key->product_name, 0, 50):''?></a></h3>
                                                        ...
                                                        <td style="border-bottom: none;" class="goods-page-price"> <strong><?php echo(isset($key->product_discount) && !empty($key->product_discount))?$key->product_discount:'0'?> <span>%</span></strong> </td>
                                                        ...
                                                        <td style="border-bottom: none;" class="goods-page-quantity">
                                                            ...
                                                            <input type="hidden" name="type" value="gcc_tbc_books">
                                                    </tr>
                                                </table>
                                            </div>
                                        </div>
                            ...
                            <a> <span> <strong>GCC-TBC Book HelpLine No: +91-9975627481</strong></span></a>
