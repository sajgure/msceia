...
<head>
    <meta charset="utf-8"/>
    <title> Payment Details  | <?php echo(isset($appname) && !empty($appname))?$appname:''; ?> </title>
                                                    ...
                                                    <table class="table table-striped table-bordered table-hover datatable" data-url="student_information_table">
                                                        <thead>
                                                            <tr>
                                                                ...
                                                                <th class="font-blue-madison bold">Transaction Number</th>
                                                                <th class="font-blue-madison bold">Payment Date</th>
                                                                <th class="font-blue-madison bold">Payment Time</th>
                                                            </tr>
                                                        </thead>
                                                        <tbody>
