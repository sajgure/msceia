                                        ...
                                        <div class="col-md-12 col-sm-12">
                                            <form method="POST" id="edit_stud_payment" action="edit_stud_payment" data-redirect="institute-list">
                                                <div class="form-body">
                                                                ...
                                                                { 
                                                                    ...
                                                                    <tr>
                                                                        ...
                                                                        <?php 
                                                                            ...
                                                                            { 
                                                                                echo '<td><center><input type="hidden" name="checkboxf" id="checkbox" value="'.$key->student_id.'">
                                                                                <input type="checkbox" class="spam form-control" name="checkbox[]" value="'.$key->student_id.'">
                                                                                </center></td>';
                                                                            }
                                                                            else if(isset($key->student_status) && !empty($key->student_status) && ($key->student_status=='appear'))
                                                                            {
                                                                                $p_cnt++;
                                                                                echo  '<td><center><input type="hidden" name="checkboxu[]" id="checkboxu" value="'.$key->student_id.'"><input type="checkbox" class="spam form-control" name="checkbox[]" value="'.$key->student_id.'" checked></center></td>'; 
                                                                            }
                                                                            else if(isset($key->student_status) && !empty($key->student_status) && ($key->student_status=='payment'))
                                                                            {
                                                                                $p_cnt++;
                                                                                echo  '<td><center><input type="hidden" name="checkboxu[]" id="checkboxu"  value="'.$key->student_id.'"><input type="checkbox" class="spam form-control" name="checkboxs[]" value="'.$key->student_id.'" checked></center></td>';
                                                                            }
                                                                        ?>
                                                                    </tr>
                                                                    <?php 
                                                    ...
                                                    <input type="submit" name="submit" class="btn blue pull-right status_save" value="Submit"> 
                                                </div>
                                            </form>
                                        </div>
                                    </div>
