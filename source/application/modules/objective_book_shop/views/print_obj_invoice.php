            ...
            <table>
                <thead>
                    <tr>
                        ...
                        <td style="text-align: right;"><b>Order No. # AP<?php echo str_pad($order_data->order_id , 6, '0', STR_PAD_LEFT);?></b><br>Date: <i><?php echo (isset($order_data->inserted_on) && !empty($order_data->inserted_on))?date('d-m-Y',strtotime($order_data->inserted_on)):'';?></i> </td>
                    </tr>
                </thead>
            </table>
            <hr>
