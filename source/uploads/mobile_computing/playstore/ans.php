...
<span class="span_div span_2 hide" >
	...
	<map name="ans2">
	  <area shape="circle" coords="280,50,20" href="javascript:void(0);" class="next" rel="3">
	  <input type="text" name="url1" class="url1" value="" placeholder="Google Play" style="position: absolute; border: medium none; width: 200px; top: 5%; left: 32%;">
	</map> 
</span>
<span class="span_div span_3 hide" >
	...
	<map name="ans3">
	  <area shape="square" coords="15,60,300,150" href="javascript:void(0);" class="next" rel="4">
	</map>
</span>
