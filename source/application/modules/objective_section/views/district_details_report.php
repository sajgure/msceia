...
<head>
    <meta charset="utf-8"/>
    <title>Objective District Details report | <?php echo (isset($appname) && !empty($appname))?$appname:'MSCEIA';?></title>
                            ...
                            <div class="portlet light">
                                <div class="portlet-title">
                                    <div class="caption font-blue">
                                        ...
                                        <span class="caption-subject bold uppercase"> District Details report </span>
                                    </div>
                                </div>
								<div class="portlet-body form">
									...
									<div class="form-actions right">
										<button class="btn green search_district" rev="search-district-details"><i class="fa fa-search"> Search </i> </button>
									</div>
									<!-- END FORM-->
								</div>
							</div>
