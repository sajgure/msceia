...
<head>
    <meta charset="utf-8">
    <title>जुने विद्यार्थी | <?php echo (isset($appname) && !empty($appname))?$appname:'MSCEIA';?></title>
...
<?php $this->load->view('site/header'); ?>
    ...
    <body class="corporate">
        <div class="main">
            <div class="container">
                <ul class="breadcrumb">
                    ...
                    <li class="active">जुने विद्यार्थी</li>
                </ul>
                    ...
                    <div class="col-md-9">
                        <div class="portlet box blue">
                            <div class="portlet-title">
                                <div class="caption"> <i class="fa fa-gift"></i>जुने विद्यार्थी </div>
                            </div>
                                    ...
                                    <div class="form-body">
                                        <div class="row">
                                           <div class="col-md-12 mt-2">
                                                ...
                                                <div class="col-md-6">
                                                    <select class="form-control select2me batch_id" name="batch_id" id="batch_id" required="">
                                                        ...
                                                        <?php if(isset($batch_data) && !empty($batch_data)) 
                                                        {
                                                            ...
                                                            { ?>
                                                                <option value="<?php echo (isset($key->batch_id) && !empty($key->batch_id))?$key->batch_id:''; ?>" <?php echo(isset($stud_data->batch_id) && !empty($stud_data->batch_id) && $stud_data->batch_id==$key->batch_id)?'selected="selected"':'';?>>
                                                ...
                                                <div class="col-md-4">
                                                   <button type="button" class="btn blue get_batch_id" data-msg="Please Select Batch." data-url="dump_old_stud_data_batchwise"> Submit</button>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
        ...
        $(document).ready(function() {            
            ...
            $.ajax({
                type:'POST',
                url:completeURL('dump_old_stud_data_batchwise'),
                data:{id:id},
                dataType:'json',
