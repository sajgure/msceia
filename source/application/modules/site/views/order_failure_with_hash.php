                    ...
                    <div>
                        <div class="portlet-body form">
                            <div class="form-body" style="text-align:center;">
                                ...
                                <h4 style="margin-bottom:20px;">Your transaction id for this transaction is <?php echo $txnid; ?> You may try again by clicking <a href='<?php echo base_url(); ?>fees'>here</a>.</h4>
