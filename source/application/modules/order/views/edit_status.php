<form action="objective_edit_status1" enctype="multipart/form-data" id="popup_save"  method="post" class="horizontal-form">
	<div class="form-body">
		<div class="row">
	        <input type="hidden" name="inst_id" value="<?php echo (isset($order_data->user_id) && !empty($order_data->user_id))?$order_data->user_id:'';?>">
			<div class="col-md-6">
				<div class="form-group">
					...
					<select class="form-control order_status select2me" name="order_status" data-placeholder="Choose a Category" tabindex="1">
                        ...
                        <option value="CANCELED" <?php echo (isset($order_data->order_status) && !empty($order_data->order_status) && $order_data->order_status=='CANCELED')?'selected=selected':''?>>CANCELED</option>
                    </select>
				</div>
