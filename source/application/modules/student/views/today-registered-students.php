...
<head>
    <meta charset="utf-8"/>
    <title>Today Registered Students | <?php echo(isset($appname) && !empty($appname))?$appname:''; ?> </title>
                            ...
                            <div class="portlet light">
                                <div class="portlet-title ">
                                    <div class="caption font-blue col-md-5">
                                        ...
                                        <span class="caption-subject bold uppercase">Today Registered Students</span>
                                    </div>
                                </div>
                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="portlet box">
                                                <div class="portlet-body">
                                                    <table class="table table-striped table-bordered table-hover datatable" data-url="today_registered_students_table">
                                                        <thead>
                                                            <tr>
