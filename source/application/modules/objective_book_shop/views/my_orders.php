                                    ...
                                    <table summary="Shopping cart">
                                        <tr>
                                            ...
                                            <th class="goods-page-stock" style="width: 15%;">
                                                <a style="float: right;" href="<?php echo base_url(); ?>view-single-order/<?php echo (isset($key->order_id) && !empty($key->order_id))?$key->order_id:''; ?>">
                                                ...
                                                { ?>
                                                    <tr>
                                                        <td class="goods-page-image" style="text-align: center;">
                                                            <strong># AP<?php echo str_pad($key->order_id, 6,'0',STR_PAD_LEFT);?></strong>
                                                        </td>
