...
<head>
    <meta charset="utf-8"/>
    <title>Course Master | <?php echo $appname; ?> </title>
                                ...
                                <div class="portlet-body form">
                                    <form action="course-master" id="course-master" class="horizontal-form" data-apikey="<?php echo(isset($keydata->key) && !empty($keydata->key))?$keydata->key:'';?>" data-redirect="course-list" method="post" enctype="multipart/form-data">
                                        ...
                                        <div class="form-actions">
                                            <a href="<?php echo base_url();?>course-list" class="btn btn-primary"> <i class=" icon-arrow-left "></i> Back</a>
                                            <div class="pull-right">  
                                                <button type="button" class="btn btn-danger clearData"> <i class="icon-close"></i> Clear </button>
                                                <button type="submit" class="btn btn-success common_save" data-pk="course_master_id" rel="<?php echo(isset($course_data->course_master_id) && !empty($course_data->course_master_id))?$course_data->course_master_id:'';?>"> <i class="icon-check"></i> <?php echo(isset($course_data->course_master_id) && !empty($course_data->course_master_id))?'Update':'Submit';?> </button>
                                            </div> 
                                        </div>
                                    </form>
                                </div>
