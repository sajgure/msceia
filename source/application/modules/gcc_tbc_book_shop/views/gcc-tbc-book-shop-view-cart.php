            ...
            <div class="row margin-bottom-40">
                ...
                <div class="col-md-12 col-sm-12">
                    <div class="goods-page">
                                ...
                                <?php $cart = $this->cart->contents();
                                    ...
                                    <table summary="Shopping cart">
                                        ...
                                        { 
                                            ...
                                            { $sub_total=$sub_total+$items['subtotal']; ?>
                                                <tr>
                                                    <td class="goods-page-image"> <a href="javascript:void(0);"><img src="<?php echo base_url();?>uploads/gcc_tbc_product_photos/<?php echo $items['product_image']?>" alt="Product Image"></a> </td>
                        ...
                        <a href="<?php echo base_url(); ?>gcc-tbc-shop">
                            <button class="btn blue" type="submit">Continue shopping <i class="fa fa-shopping-cart"></i></button>
                        </a> <a style="margin-left: 100px;"><span><strong>GCC-TBC Book HelpLine No: +91-9975627481</strong></span></a>
                        <a href="<?php echo base_url();?>gcc-tbc-book-shop-checkout">
