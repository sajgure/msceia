						...
						<?php if(isset($stud_result) && !empty($stud_result))
                        	...
                        	{ ?>
								<div class="col-md-12" >
									...
									<div style=" position: absolute; top: 79.8%; left: 75.2%; color: #031228;"><b><?php echo(isset($key->speed_marks) && !empty($key->speed_marks))?$key->speed_marks:'0'?><?php if($key->grace=='*') { echo "<sup>*</sup>";} ?> </b> </div>
