...
<head>
    <meta charset="utf-8"/>
    <title>Certificate Report List | <?php echo (isset($appname) && !empty($appname))?$appname:'MSCEIA'; ?></title>
                            ...
                            <div class="portlet light">
                                <div class="portlet-title">
                                    <div class="caption font-blue">
                                        ...
                                        <span class="caption-subject bold uppercase">Certificate Report List</span>
                                    </div>
                                    <div class="action" style="float: right;">
                                        <a target="_blank" href="<?php echo base_url(); ?>all-pass-student-list" class="btn btn-success tooltips" title="Pass Student List" >Pass Student List</a>
                                    </div>
                                </div>
                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="portlet box">
                                                <div class="portlet-body">
                                                    <table class="table table-striped table-bordered table-hover datatable" data-url="certificate_list">
                                                        <thead>
                                                            <tr class="heading">
                                                                ...
                                                                <th class="font-blue-madison bold">Pass Student</th>
