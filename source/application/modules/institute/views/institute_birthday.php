...
<head>
    <meta charset="utf-8"/>
    <title>Institute Birthday | <?php echo(isset($appname) && !empty($appname))?$appname:'MSCEIA'; ?> </title>
                            ...
                            <div class="portlet light">
                                <div class="portlet-title">
                                    <div class="caption font-blue col-md-7">
                                        ...
                                        <span class="caption-subject bold uppercase">Institute Birthday</span>
                                    </div>
                                    <div class="actions pull-right col-md-5">
                                        ...
                                        <div class="col-md-4">
                                            <button rev="instBirthdayWish" class="btn btn-primary btn-sm stud_birthday" ><i class="fa fa-envelope"></i> <strong>SEND WISHES</strong></button>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="portlet box">
                                                <div class="portlet-body">
                                                    <table class="table table-striped table-bordered table-hover datatable" data-url="institute_birthday_table">
                                                        <thead>
                                                            <tr>
                                                                <th  class="font-blue-madison bold" style="text-align: center;">#</th>
                                                                <th class="font-blue-madison bold"> Institute Owner Name </th>
