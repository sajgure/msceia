	  	...
	  	<div style="border:1px solid black;">
	  		<div style="padding: 10px;">
		        	...
		        	<thead>
		                <tr>
		                   <td width="75%;">
			                ...
			                <td width="25%;">
			                	<h4 style="text-align: right;">Order No. <b># MS<?php echo str_pad($order_data->order_id , 6, '0', STR_PAD_LEFT);?></b><br>Order Date. <b><?php echo (isset($order_data->inserted_on) && !empty($order_data->inserted_on))?date('d-m-Y', strtotime($order_data->inserted_on)):''; ?></b></h4>
		                   </td>
		                </tr>
		            </thead>
		        </table>
		        ...
		        <table>
		            <thead id="footer">
		                <tr>
		                    <td width="80%" style="text-align: right;text-transform: capitalize;">
		                        <b>Sender:<br>
		                        For MSCEIA<br>
		                        Manisha Foundation,<br> 
		                        MURALI SHAKUNTAL COMPLEX,<br>
		                        SANGAMNER - 422605<br>
		                        Mo.: +91-9975627481</b><br>
		                    </td>
		                </tr>
		            </thead>
		        </table>
