...
if (empty($cart)) { redirect('gcc-tbc-shop'); }?>
<?php  
        ...
        <div class="main">
            <div class="container">
                ...
                <div class="row margin-bottom-40">
                    ...
                    <form action="gcc_tbc_book_online_order" enctype="multipart/form-data" id="gcc_tbc_book_online_order" data-redirect="gcc-tbc-payment" method="post" class="horizontal-form">
                                            ...
                                            <div class="col-md-12 clearfix">
                                                <div class="table-wrapper-responsive">
                                                    ...
                                                    <table>
                                                        ...
                                                        {
                                                            if($items['options']['type'] == 'gcc_tbc_books')
                                                            { 
                                                                if($items['id']!=6){$total_qty = $total_qty+$items['qty'];}
                                                                $sub_total=$sub_total+$items['subtotal']; ?>
                                                                <tr>
                                                                    <td class="checkout-image"> <a href="javascript:;"><img src="<?php echo base_url();?>uploads/gcc_tbc_product_photos/<?php echo $items['product_image']?>" alt="Berry Lace Dress"></a> </td>
                                                                    <td class="checkout-description">
                                                                        <h3><a style="text-decoration: none;font-weight:600;" href="javascript:;"><?php echo $items['name']; ?></a></h3>
                                                ...
                                                <div class="checkout-total-block">
                                                    <?php if(isset($total_qty) && ($total_qty<15))
                                                    {
                                                      $shipping= 100;
                                                    } 
                                                    else{
                                                ...
                                                <br> <a><span><strong style="color: #E02222;">GCC-TBC Book HelpLine No: +91-9975627481</strong></span></a>
                                                <span><strong style="color:red;margin-left: 3%;">दिलेली ऑर्डर येण्याकरिता ५ ते ६ working days लागतील.</strong> </span>
                                                <?php if(isset($total_qty) && ($total_qty>=15))
                                                {?>
                                                    <!--<a href="<?php echo base_url();?>gcc-tbc-payment" class="btn btn-primary pull-right" style="color:#fff;">PAY ONLINE</a>-->
                                                    <button class="btn btn-primary pull-right pay_gcc_tbc_shop_order" type="submit" id="button-confirm">PAY ONLINE</button>
                                                <?php }
                                                else { ?>
                                                    <span style="float: right;"><strong style="color:red;">Note :- कमीतकमी २५ पुस्तकांची ऑर्डर द्यावी.</strong> </span>
                                                <?php } ?>
                                            </div>
                                        </div>
                                    </div>
