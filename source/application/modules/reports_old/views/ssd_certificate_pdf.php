...
<head>
	<style>
		...
		.certificate{
			background-image: url('<?php echo base_url(); ?>images/certificate_ssd.png'); 
		}
	</style>
</head>
						...
						<?php if(isset($stud_result) && !empty($stud_result))
                        	...
                        	{ ?>								
								<div class="col-md-12" >
									...
									<div style=" position: absolute; top: 79.8%; left: 37.5%; color: #031228;"><b><?php echo(isset($key->objective_marks) && !empty($key->objective_marks))?$key->objective_marks:'0'?><?php if($key->grace1=='*') { echo "<sup>*</sup>";} ?> </b> </div>
									<div style=" position: absolute; top: 79.8%; left: 60.8%; color: #031228;"><b><?php echo(isset($key->group_marks) && !empty($key->group_marks))?$key->group_marks:'0'?> </b> </div>
